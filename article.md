...
![System design: the app opens a session and asks what's next; the backend reads the versioned flow definition, validates each submitted step, and returns the next step to render](system-design.gif)
